...
export class GdmLiveAudioVisuals extends LitElement {
  ...
  // FIX: Use `protected` for LitElement lifecycle methods. Replaced `this.renderRoot` with `this.shadowRoot!` to correctly access the shadow DOM.
  ...
  // FIX: LitElement's render method must be protected to correctly override the base class method.
  protected render() {
